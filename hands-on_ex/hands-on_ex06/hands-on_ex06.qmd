...
::: callout-note
Note: For effective interpretation, is it better to plot both the GDPPC values map and its corresponding quadrants map next to each other.
...
Having many neighbours smooths the neighbour relationship across more neighbours. So we can control the number of neighbours using k-nearest neighbours and either accepting asymetric neighbours or imposing symmetry as shown in this code chunk below.
